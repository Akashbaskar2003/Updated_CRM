...
export const Navbar: React.FC<NavbarProps> = ({ onToggleSidebar }) => {
  ...
  return (
    <header className="sticky top-3 z-30 w-full rounded-2xl glass-shell transition-all">
      <div className="flex h-16 items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div
            className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-purple-500 to-fuchsia-500 text-xs font-bold text-white shadow-glow"
